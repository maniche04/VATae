package com.nagisons.vatfacts.utils;
...
public class RssHandler extends DefaultHandler {
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        SimpleDateFormat sdf = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss zzz", Locale.getDefault());
        if (currentItem != null) {
            ...
            if (parsingTitle)
                ...
                try {
                    currentItem.setPubDate(sdf.parse(new String(ch,start,length)));
